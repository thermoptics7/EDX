...
def modify_list(myList):
    ...
    for i in range(0,3):
        myList.pop()
    #print("List after popping 3x:", myList)

    try:
        myList.remove(7)
    except:
        print("There are no 7s in this list!!!")

    #print("List after deleting 7s:", myList)

    myList[0] = myList[0] * 2
    myList[2] = myList[2] * 2
    #print("List after maths:", myList)
...
import math
testList = [7, 4, 3, 2.0, 81, 37.5, 89, math.pi, -2, math.e]
#testList = [10, 4, 3, 2.0, 81, 37.5, 89, math.pi, -2, math.e]
print("Length of Original List:", len(testList))
print("Original List:", testList)
print("Modified List:", modify_list(testList))
